...
class _ProductosPublicListState extends State<ProductosPublicList> {
  ...
  void didChangeDependencies() {
    ...
    favoritosProvider.checkAndUpdateUsuario(); // 👈 Asegura que esté usando el usuario correcto
  }

  Future<void> cargarProductos() async {
    try {
      final response = await http.get(Uri.parse('http://localhost:3005/productos'));
