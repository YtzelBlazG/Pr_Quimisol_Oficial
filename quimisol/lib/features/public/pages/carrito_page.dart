...
class _CarritoPageState extends State<CarritoPage> {
  ...
  Future<void> _eliminarProducto(int idProducto) async {
    ...
    final url = Uri.parse('http://localhost:3005/carrito/$idUsuario/$idProducto');
  ...
  Future<void> _finalizarCompra() async {
    try {
      ...
      final url = Uri.parse('http://localhost:3005/pedidos/crear-desde-carrito/$idUsuario');
      ...
      if (resp.statusCode == 201) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('¡Pedido #$idPedido creado!')),
        );
        ...
        final msg = jsonDecode(resp.body)['message'] ?? 'Error al crear el pedido';
                      ...
                      child: ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            ...
                            Text('Precio unitario: ${precio.toStringAsFixed(2)} Bs'),
                            Text(
