...
import '../../../../auth/presentation/screens/request_code_screen.dart';
  ...
  Future<void> _handleSubmit() async {
    ...
    if (_showRegister) {
      ...
      try {
        ...
        // 🔹 Al registrarse → siempre rol cliente
      ...
      try {
        ...
        // Esperado: { usuario: { idpersona, nombre, correo, telefono, rol } }
